"use client";
import { useCreateFacultyForm } from "@/hooks/admin/faculty/useCreateFacultyForm";
...
export default function AddFacultyModal() {
  ...
  const { register, control, errors, isPending, onSubmit, departmentOptions  } =
    useCreateFacultyForm(() => setOpen(false));
      ...
      <Dialog.Portal>
        ...
        >
          <div className="flex items-center justify-between pb-5 border-b border-border shrink-0">
            <Dialog.Title className="title">Add New Faculty</Dialog.Title>
