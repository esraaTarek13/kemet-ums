"use client";
import { useUpdateCourseOfferingForm } from "@/hooks/admin/courses/useUpdateCourseOfferingForm";
      ...
      <Dialog.Portal>
        ...
        >
          <div className="flex items-center justify-between pb-5 border-b border-border shrink-0">
            <Dialog.Title className="title">Edit Course Details</Dialog.Title>
